...
public class TypeProductionResponse {
    ...
    public TypeProductionResponse() {
    }

    public TypeProductionResponse(Long typeProductionId, String name, String jsonStructure, String alias, String catalogsIds) {
