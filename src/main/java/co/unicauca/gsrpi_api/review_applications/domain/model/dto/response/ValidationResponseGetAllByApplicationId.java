...
public class ValidationResponseGetAllByApplicationId {
    ...
    public ValidationResponseGetAllByApplicationId(long validationId, String validationState, String observations, ValidationType validationType, PersonResponseGetAllByApplicationId person) {
